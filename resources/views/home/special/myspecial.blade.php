...
<div class="wrap alm2 clear_fix specialPage">
  ...
  <div class="r">
      <ul id="ulAlbums">
            ...
            <div class="detail">
                <div class="top"><div style="margin-left:50px;" ><strong><a title="{{$v->title}}" href="/home/special/listspecial/{{$v->gdid}}" >{{$v->title}}</a><div style="float:right;" >制作人：{{$v->zhizuo}}</div></div>
                <!--<span>()</span>-->
                </strong></div>
                ...
                <div class="btn">
                    <span><i class="t2">类型:@if($v->styles ==0) 电子
				                            ...
				                            @endif</i></span>
					<span style="margin-left: 450px;"><a href="/home/special/edit/{{$v->gdid}}" class="mws-gallery-btn"><i class="icon-pencil">修改</i></a>
                    <a href="/home/special/destroy/{{$v->gdid}}" class="mws-gallery-btn  shan" ><i class="icon-trash">删除</i></a></span>
                </div>                                                                  
            </div>
        </li>
        @endforeach
